...
class CityController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->has('search')) {
            $cities = City::where('state_id', 'like', "%{$request->search}%")->orWhere('name', 'like', "%{$request->search}%")->get();
        }
    ...
    public function destroy(City $city)
    {
        ...
        return redirect()->route('cities.index')->with('message', 'You successfully deleted the city!');
    }
}
