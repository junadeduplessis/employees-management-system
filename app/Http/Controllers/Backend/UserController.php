...
class UserController extends Controller
{
    ...
    public function destroy(User $user)
    {
        if (auth()->user()->id === $user->id) {
            return redirect()->route('users.index')->with('fail', 'You cannot delete yourself!');
        }

        $user->delete();

        return redirect()->route('users.index')->with('message', 'You successfully deleted the user!');
    }
}
