                ...
                <form>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <select
                                ...
                                @change="getStates(), form.state_id = '', form.city_id = ''"
                                id="country"
                                type="text"
                                class="form-control"
                                required
                    ...
                    <div class="form-group row mb-0">
                        <div class="col-md-6 offset-md-4">
                            <button type="submit" class="btn btn-primary" @click.prevent="storeEmployee()">
                                Add
                            </button>
                        </div>
                    </div>
        ...
        storeEmployee() {
            axios
                .post("/api/employees", {
                    ...
                    'birth_date': this.customDateFormatter(this.form.birth_date),
                    'date_hired': this.customDateFormatter(this.form.date_hired),
                })
                .then(response => {
